---
layout: post
title: A double whammy! Measuring AND cleaning fusion fuel from a fusion reactor wall.
...
![Etcher_schematic]({{ site.url | absolute_path}}/assets/images/etcher_laser_schematic.PNG){:height="75%" width="75%"}
 <figcaption>
...
![TPD]({{ site.url | absolute_path}}/assets/images/WD4_TDS_sim.PNG){:height="50%" width="50%"}
 <figcaption>
...
![LIDS]({{ site.url | absolute_path}}/assets/images/LIDS_20181101.png){:height="50%" width="50%"}
 <figcaption>
...
![LIDS]({{ site.url | absolute_path}}/assets/images/LIDS_summary.png){:height="50%" width="50%"}
 <figcaption>
